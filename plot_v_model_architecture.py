...
#three subplots here -- accuracy vs number of layers, accuracy vs number of nodes per layer, accuracy vs nodes times layers.
#maybe also do the same thing with sig_frac?
