...
min_mass = config_pars['data']['min_fom'] # 0.0
max_mass = config_pars['data']['max_fom'] # 1.0
mean_mass = config_pars['data']['mean_fom'] # 0.5
width_mass = config_pars['data']['width_fom'] # 0.03
